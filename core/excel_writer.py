...
class ExcelWriter:
    ...
    BASE_COLUMNS = [
        'Объект', 'Координаты', 'Название объекта', 'Ссылка',
        'Фото объекта', 'Тип объекта', 'Адрес', 'Телефон',
        'Сайт', 'Адрес электронной почты', 'Парковка',
        'Ссылка на парковку', 'Название парковки', 'Оценка парковки',
        'Количество оценок', 'Адрес парковки', 'Время работы парковки',
        'Тип парковки', 'Тарифы', 'Доступ', 'Вместимость',
        'Отзывы о парковке', 'Цены', 'Фото парковки',
